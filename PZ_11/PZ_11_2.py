...
f1 = open("PZ_11/text18-21.txt", "r", encoding="UTF-8") #Открытие файла в режиме чтения
f2 = f1.read()
score = 0 # счетчик
...
f4 = open("PZ_11/zadanie_2.txt", "r", encoding='UTF-8') #Открытие файла в режиме чтения
...
f4 = open("PZ_11/zadanie_2.txt", "w+", encoding="UTF-8") #Открытие файла в режиме как и чтения, так и записи.
