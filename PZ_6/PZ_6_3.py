...
try:
    ...
    B.append(a)
    B.append(b)
except ValueError:  ### Обработчик исключений, который выводит ошибку, в случае если введённое числа a,b не в int типе
    print('Ошибка')
    ...
    for i in range(len(list_x)): #Цикл в котором перебираются все значения в списке list_x
        ...
        id = 0 # Счётчик
        while id <= c - 1: # Цикл в котором проверяются все значения в списке list_2 и выводится близжайшая точка
