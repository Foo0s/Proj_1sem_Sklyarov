...
class Sound():
    def __init__(self):
        self.sound_bullet = path.join(path.dirname("I:/Манакова/Proj_1sem_Sklyarov/Project_Game/alien_invasion/sound/laser-blast-descend_gy7c5deo"))
        self.sound_crush_alien = path.join(path.dirname("I:/Манакова/Proj_1sem_Sklyarov/Project_Game/alien_invasion/sound/crush"))
